...
export function ComponentLibrary3D() {
  ...
  const handleAddComponent = (comp: typeof componentsData[0]) => {
    ...
    addComponent({
      ...
      body_shape: comp.body_shape,
      dimensions: {
        diameter: comp.body_diameter_mm,
        length: comp.body_length_mm,
        width: comp.body_width_mm,
        height: comp.body_height_mm || comp.height_mm,
        depth: comp.body_length_mm,
        outer_diameter: comp.outer_diameter_mm,
        inner_diameter: comp.inner_diameter_mm,
      },
      lead_configuration: comp.lead_configuration,
      suggested_hole_diameter_mm: comp.suggested_hole_diameter_mm,
      end_inset_mm: comp.end_inset_mm,
      lead_pattern: comp.lead_pattern,
